    ...
    <style>
        * {
        ...
        .new-btn-login {
            ...
            background-image: url("<c:url value='/resources/images/new-btn-fixed.png'/>");
            border: medium none;
        }
...
<div id="main">
    ...
    <form name=alipayment action="<c:url value="/order/pay"/>" method=post target="_blank">
        <div id="body" style="clear:left">
            <dl class="content">
                <dt>商户订单号：</dt>
                <dd>
                    <span class="null-star">*</span>
                    <input size="30" name="orderId" id="orderId"/>
                    <span></span>
                </dd>
                <dt>付款金额：</dt>
                <dd>
                    <span class="null-star">*</span>
                    <input size="30" name="price" id="price"/>
                    <span></span>
                </dd>
                <dt>订单名称：</dt>
                <dd>
                    <span class="null-star">*</span>
                    <input size="30" name="description" id="description"/>
                    <span></span>
                </dd>
                <dt></dt>
                <dd>
